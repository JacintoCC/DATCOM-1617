---
title: "Minería de datos - Aspectos avanzados"
subtitle: "Informe de competición en Kaggle - Imbalanced"
...
```{r}
ggplot(data.tra, aes(x=ATSCHL, y = ANXMAT, color =PV1MATH)) + geom_point()
```