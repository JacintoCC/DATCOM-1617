...
# Ejercicios de evaluación continua de regresión 
...
#    Comenzamos haciendo una visualización de la variable de salida con respecto a las demás. Para
# ello, usaremos `ggplot2` y `tidyr` para agrupar los gráficos.
...
# a las dos variables por separado se observan precios elevados en dos intervalos, con lo que para
# intentar recoger esta variabilidad tendríamos que usar una función de grado 4.
# 
...
# Hacemos ahora validación cruzada para California. 
